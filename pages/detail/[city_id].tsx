...
export async function getServerSideProps(pContext: GetServerSidePropsContext) {
    const { city_id } = pContext.query
...
export default function DetailCity({ city, weather }: Props) {
